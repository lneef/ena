...
- If behavior is ambiguous ALWAYS consult the resources (**spec** and the reference implementation in amzn-drivers/)
...
5. Use tests comply with the references resources 
    - Use @verifier
